...
def crop_journal_image(path):
    ...
    try: 
        ...
        logger.error('[crop_journal_image completed]')
        logger.error(traceback.format_exc())        
        raise
    else: 
        stop_time = time.time()
        dt = stop_time - start_time
        logger.info(f"[crop_journal_image completed] {ppt_path} in {dt} s")
...
def resize_image(path):
    ...
    # perform the actual resizing of the img and show it
